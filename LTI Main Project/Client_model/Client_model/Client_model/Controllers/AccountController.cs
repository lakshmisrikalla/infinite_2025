...
namespace Client_model.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult Register(RegisterClientVm model)
        {
            ...
            _db.SaveChanges(); // get login.LoginID
            ...
            var client = new Client
            {
                ...
                ContactPhone = model.ContactPhone,   // <-- store phone from form
                Status = "Pending",
            ...
            {
                // fallback: show code on screen in dev if emails disabled or failed
        ...
        public ActionResult Login(LoginVm model)
        {
            ...
            // Successful login: set session and redirect to profile
            Session["LoginID"] = login.LoginID;
            Session["ClientID"] = client.ClientID;
            Session["Username"] = login.Username;

            // redirect to MyProfile (clean)
        ...
        // GET: Change password (client must be logged in)
        [HttpGet]
        ...
        public ActionResult ChangePassword(ChangePasswordVm model)
        {
            ...
            // redirect to MyProfile for consistency
            return RedirectToAction("MyProfile", "Client");
        }
